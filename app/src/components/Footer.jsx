      ...
      <div className="max-w-7xl   mx-auto px-4 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-8">
            {/* Customer Care */}
            <div>
              <h3 className="font-bold text-lg mb-4 text-gray-200">24/7 Customer Care</h3>
              <div className="space-y-2">
                <p className="text-gray-400">
                  <span className="font-semibold text-white">Email Support:</span> support@onesimulation.com
                </p>
                <p className="text-gray-400">
                  <span className="font-semibold text-white">Call:</span> +91-22-6198-7777
                </p>
              </div>
            </div>
